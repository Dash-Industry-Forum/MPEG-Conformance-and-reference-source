...
public class PeriodType {
    ...
    protected List<EventStreamType> eventStreams;
    ...
    /**
     * Gets the value of the eventStreams property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the eventStreams property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEventStreams().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<EventStreamType> getEventStreams() {
        if (eventStreams == null) {
            eventStreams = new ArrayList<EventStreamType>();
        }
